...
class GraphConditionedNorm(nn.Module):
    ...
    def __init__(self, in_channels: int, hidden_dim: int = 128):
        super().__init__()
        """
        Will take in the stat dimension and through linear neural network layers and gaussian activation,
        Will capture the scale and shift, basically normalizing the input vector.
        """
